  ...
  return (
    ...
    >
      ...
      <Box className='nav-links' sx={{ width: '35%'}}>
        ...
        <Link  to="/clients"  style={{ textDecoration:"none", fontFamily:"Epilogue",color:"#FFFFFF",fontWeight:"500"}} ><Typography  className='typo-links'  variant="body1">Clients</Typography></Link>
