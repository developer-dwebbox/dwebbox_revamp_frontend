  ...
  return (
    <div className='Bgimage'>
      ...
      <div className='bgcontentsection'>
        ...
        <a style={{ textDecoration: "none",color:"white" }}  rel="noreferrer" href="https://api.whatsapp.com/send?phone=+918828103808&text=Hello" target="_blank" className='bgcontentbtn'>
        <ArrowOutward/>
    <p>Get In Touch</p>
    </a>
        </div>
